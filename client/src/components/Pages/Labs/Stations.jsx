...
export default function Stations() {
  ...
  return (
    <div className="relative overflow-x-hidden">
      <div className="top relative lg:mx-20 md:mx-16 sm:mx-14 mx-12 w-full lg:pl-24 md:pl-10 lg:pt-8 pt-4 text-base ">
        <p className="w-fit rounded-lg bg-slate-50 lg:p-2 lg:text-xl text-base font-bold text-sky-900">
          <Link
      ...
      <div className="mx-auto max-w-[80vw] overflow-y-auto bg-white">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex w-full items-center justify-between">
            <div></div>
            <div className="hidden flex items-center rounded-lg border border-slate-300 bg-white p-1 shadow-sm hover:border-sky-300">
              <input
                type="text"
